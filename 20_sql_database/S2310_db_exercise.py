...
def create_test_data():
    with Session(engine) as session:
        session.add_all([
            Customer(name="Jan", address="denmark", age=18),
            Customer(name="Peter", address="denmark", age=28),
            Customer(name="Harry", address="denmark", age=23),
            Product(product_number=1000, price=5000, brand="Apple"),
            Product(product_number=1001, price=4000, brand="Samsung")
        ])
        session.commit()
