...
Commit filen til dit eget git-repository (commit betyder: sikkerhedskopier den aktuelle tilstand
af dine filer som en ny version)
...
På GitHub-websiden for dit repository skal du klikke på "Settings" (indstillinger) og sikre dig,
at dit repository er offentligt (General, Change repository visibility).
