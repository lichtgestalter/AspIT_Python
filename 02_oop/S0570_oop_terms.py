...
object1 = ClassName(4, 160)  # creates an instance/object by implicitly calling the constructor __init__
object1.method1()  # calls method1 on object1
object1._protected_method()  # don't do this
print(object1)  # calls implicitly __repr__ on object1
...
print(object2)  # calls implicitly __repr__ on object1
object2.method1()  # calls method1 on object2

print("\n--- Example for polymorphism ---")
objectlist = [object1, object2]
for obj in objectlist:
    obj.method1()  # calls different versions of method1(), depending on the type of obj. This is an example for polymorphism.
